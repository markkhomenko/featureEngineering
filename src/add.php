...
if ($Paper->isfinal()) {
    ...
    $results[1] = '<p>你的结果已经成功添加到数据库。</p><p>如果您后面需要删除自己的信息（用于更新或者其他用途），请妥善保管这个代码： ' . $res . '。您在 30 天内，浏览器会保留您的删除信息的权限。过期或者浏览器切换后可以使用该码在页面右下角的“激活 TOKEN”处激活代码。</p><p>这样做保证了系统不会存储用户的个人信息。</p>';
...
<br/>
<p>填写该报告可能需要 10-20 分钟。您填写越详细，提供给师弟师妹的帮助就越多！</p>
<br/>
