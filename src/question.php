...
class Paper
{
    ...
    {
        if (!isset($this->questions[$this->pos])) {
            return true;
        } else {
            return false;
        }
...
class Question
{
    ...
    public function __construct($uniqueid, $title, $type, $details, $conditionInsert, $conditionValid)
    {
        global $result;
...
$Paper->addQuestion(new Question('SubjectInformation', '<p>请选择您的录取信息所属的学科，如果您没有找到您的大类学科，请联系本年度飞跃 QQ 群。</p>', 'select', join('/', $subjectinfo), '', ''));
...
$Paper->addQuestion(new Question('GpaStatement', '<p>请提供你的本人的在校学业表现（例如 GPA）。这是一个<b>非常选择性</b>的问题，您可以不回答，也可以回答。您如果回答，可以详细提供排名，也可以不提供。您可以保留一位小数，或者给出两位小数。您可以说中等偏上，也可以说比较一般。</p>', 'text', 'e.g. GPA3.0', '', ''));
...
$Paper->addQuestion(new Question('CSCStudent', '<p>您申请了 CSC 的资助，并且在申请阶段中表明了自己将会使用 CSC 的资助就读吗？</p>', 'select', 'yes=是的，我使用了 CSC 申请的途径。/no=否，我没有。', '', ''));

$Paper->addQuestion(new Question('MitacsStudent', '<p>您是 Mitacs Globalink 项目的学生，毕业后申请的是和 Mitacs 有合作关系的学校，并且在申请阶段表明自己有 Mitacs 的资助吗？</p>', 'select', 'yes=是的，我将去加拿大学习，并且使用 Mitacs 的研究生资助。/no=否，我没有。', '', ''));
...
<p>意料之中|意料之外，主要是方向匹配|经历有关，喜欢她做的内容，面试的时候回答的比较好。交流阶段做的内容相关。拿到一个交流的老师的推荐信。有比较好的奖学金，例如郭奖，国奖（很可能暴露您的个人信息）。对方是科大校友。希望学弟学妹早点准备英语。</p><p><b>如果您愿意，</b>欢迎提供您的联系方式。最好是您出国后还会使用的联系方式，例如微信、QQ、国外邮箱、Facebook 帐号。请您放心，只有中科大的同学可以进来。</p>', 'text', 'e.g. （尽量不要留空）', '', ''));
